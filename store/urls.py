...
urlpatterns = [
    ...
    path('atualizar-carrinho/<int:product_id>/', views.update_cart_item, name='update_cart_item'),
    path('remover-do-carrinho/<int:product_id>/', views.remove_from_cart, name='remove_from_cart'),
